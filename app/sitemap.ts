...
export default function sitemap(): MetadataRoute.Sitemap {
  ...
  return [
    ...
    { url: `${baseUrl}/tools/add-text`, lastModified: today, changeFrequency: "monthly", priority: 0.8 },
    { url: `${baseUrl}/tools/text-to-image`, lastModified: today, changeFrequency: "monthly", priority: 0.8 },
    { url: `${baseUrl}/tools/image-to-svg`, lastModified: today, changeFrequency: "monthly", priority: 0.8 },
